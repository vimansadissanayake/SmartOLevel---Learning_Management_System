...
$assignment_grades = $conn->query($assignment_grades_query);
...
$quiz_attempts_query = "SELECT qa.score, qa.percentage, qa.attempted_at,
                        ...
                        INNER JOIN users t ON q.teacher_id = t.user_id
                        ORDER BY qa.attempted_at DESC";
$quiz_attempts = $conn->query($quiz_attempts_query);
?>
...
<head>
    <meta charset="UTF-8">
    <title>Admin Results - SmartOLevel LMS</title>
    ...
    <header class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-4 shadow-lg">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-indigo-100">Admin Results Overview</p>
            </div>
            <div class="flex items-center gap-4">
                ...
                <a href="admin_dashboard.php" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">Back to Dashboard</a>
            </div>
        </div>
    </header>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($grade['teacher_name']); ?></td>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($attempt['teacher_name']); ?></td>
